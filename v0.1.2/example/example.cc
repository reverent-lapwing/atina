...
namespace Actions
{
 ...
 {
  public:
   static unique_ptr<action_base> New( double toWait )
   {
    return make_unique<Wait>(Wait{toWait});
   }
   unique_ptr<action_base> Copy()
   {
    return New(toWait);
   }
 ...
 {
  public:
   static unique_ptr<action_base> New( Position destination )
   {
 ...
 {
  public:
   static unique_ptr<action_base> New( function<Task(Mob::Mob&)> task )
   {
